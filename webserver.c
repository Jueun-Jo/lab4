...
{
	int sockfd, new_fd; /* listen on sock_fd, new int sockfd, new_fd; */
	struct sockaddr_in server_addr; /* structure to struct sockaddr_in server_addr; */
	struct sockaddr_in client_addr; /* structure to hold struct sockaddr_in client_addr; */
	int alen; /* length of address */
	fd_set readfds, activefds; /* the of read descriptors */
